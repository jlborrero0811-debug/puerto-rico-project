...
const translations = {
    english: { 
        ...
        navMap: "<i class='fa fa-map'></i> Map",
        ...
        mapTitle: 'Puerto Rico Map',
        mapInstructions: 'Click on one of the colored regions on the map and choose a city below to explore.',
        mapDefaultName: 'Explore Puerto Rico',
        mapDefaultDescription: 'Discover the city regions on the Puerto Rico map.',
        mapLoadDescription: 'Click a pin on the map or choose a city below to explore. Pins are color-coded by region.',
        mapRegionLabel: 'Region',
        legendNorth: 'North',
        legendSouth: 'South',
        legendEast: 'East',
        legendWest: 'West',
        legendCentral: 'Central',
        legendMetropolitan: 'Metropolitan',
    ...
    spanish: {
        ...
        navMap: "<i class='fa fa-map'></i> Mapa",
        ...
        mapTitle: 'Mapa de Puerto Rico',
        mapInstructions: 'Haz clic en una de las regiones de color en el mapa y elige una ciudad a continuación para explorar.',
        mapDefaultName: 'Explorar Puerto Rico',
        mapDefaultDescription: 'Descubre las regiones de ciudades en el mapa de Puerto Rico.',
        mapLoadDescription: 'Haz clic en un alfiler en el mapa o elige una ciudad a continuación para explorar. Los alfileres están codificados por color según la región.',
        mapRegionLabel: 'Región',
        legendNorth: 'Norte',
        legendSouth: 'Sur',
        legendEast: 'Este',
        legendWest: 'Oeste',
        legendCentral: 'Central',
        legendMetropolitan: 'Metropolitana',
