...
document.addEventListener('DOMContentLoaded', function () {
    ...
    startImageCycle(
        ...
        'pic2map',
        [
            'images/map/flagleft1.png',
            'images/map/flagleft2.png'
        ],
        [
            'images/map/flagright1.png',
            'images/map/flagright2.png'
        ]
    );
    // Quiz page
    startImageCycle(
        ...
        'pic2quiz',
        [
            'images/quiz/flagleft1.png',
            'images/quiz/flagleft2.png'
        ],
        [
            'images/quiz/flagright1.png',
            'images/quiz/flagright2.png'
        ]
    );
    // Account page
    startImageCycle(
        ...
        'pic2acc',
        [
            'images/account/flagleft1.png',
            'images/account/flagleft2.png'
        ],
        [
            'images/account/flagright1.png',
            'images/account/flagright2.png'
        ]
    );
});