...
function getVisitedCitiesCount(profile) {
...
function buildProfileMarkup() {
    ...
    return `
        <div class="quiz-profile-card">
            ...
            <div class="cities-visited-section">
            ...
            <div class="reset-progress-section">
                <button class="btn-reset" id="reset-progress-btn" onclick="resetAllProgress()">Reset All Progress</button>
            </div>
        </div>
    `;
}
...
// Reset all saved progress and quiz state.
function resetAllProgress() {
    if (confirm('Are you sure? This will delete all your progress, achievements, and quiz history. This cannot be undone.')) {
        localStorage.removeItem(PROFILE_STORAGE_KEY);
        localStorage.removeItem('quizState');
        alert('All progress has been reset. Refresh the page to start fresh.');
        location.reload();
    }
}